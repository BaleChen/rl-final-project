...
#SBATCH --mail-user=bc3088@nyu.edu # NOTE: put your netid here if you 
want emails

# #SBATCH --array=0-11 # here the number depends on number of tasks in 
the array, e.g. 0-11 will create 12 tasks
