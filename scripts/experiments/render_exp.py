...
def render_agent(agent, test_env, max_ep_len, logger, n_eval=1, save_folder='./', save_name_prefix='', action_noise=False):
    ...
    for j in range(n_eval):
        ...
        while not (d or (ep_len == max_ep_len)):
            ...
            a = agent.get_test_action(o) if not action_noise else agent.get_exploration_action(o, test_env)
...
exp_name = 'exp_e300_q10_uf9_lr0.0003_g0.99_p0.995_ss5000_b128_h128_rs3'
seed = 1
env_names = ['Hopper-v3','HalfCheetah-v3']
epoch = 300

save_name_prefix = f'sac_b128_h128_ep{epoch}'
...
# This file has been modified multiple times to render images for different settings. This version is just
# the latest configuration that I used.
